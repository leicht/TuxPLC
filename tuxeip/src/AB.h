...
typedef enum _PLC_Data_Type{PLC_ERROR=E_Error,PLC_UNKNOW=0,PLC_BIT=1,PLC_BIT_STRING,PLC_BYTE_STRING,PLC_INTEGER,PLC_TIMER,PLC_COUNTER,PLC_CONTROL,PLC_FLOATING,PLC_ARRAY,PLC_ADRESS=15,PLC_BCD} PLC_Data_Type;
typedef enum _LGX_Data_Type{LGX_ERROR=E_Error,LGX_UNKNOW=0,LGX_BOOL=0xC1,LGX_BITARRAY=0xD3,LGX_SINT=0xC2,LGX_INT=0xC3,LGX_DINT=0xC4,LGX_REAL=0xCA} LGX_Data_Type;
